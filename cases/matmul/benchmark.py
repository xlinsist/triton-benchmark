...
from matmul_autotvm import benchmark_autotvm,benchmark_autotvm_single
...
def main():
    ...
    methods = [
        ...
        ('hidet_single', benchmark_hidet_single), ('tvm_single', benchmark_tvm_single), ('triton_single', benchmark_triton_single), ('autotvm_single', benchmark_autotvm_single)
    ]
