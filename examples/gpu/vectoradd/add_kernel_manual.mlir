module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, ttg.target = "cuda:86", "ttg.threads-per-warp" = 32 : i32} {
  ...
  llvm.func @add_kernel(%arg0: !llvm.ptr<1> {tt.divisibility = 16 : i32}, %arg1: !llvm.ptr<1> {tt.divisibility = 16 : i32}, %arg2: !llvm.ptr<1> {tt.divisibility = 16 : i32}, %arg3: i32 {tt.divisibility = 16 : i32}, %arg4: !llvm.ptr<1>) attributes {noinline = false, nvvm.kernel = 1 : ui1, nvvm.reqntid = array<i32: 128>} {
    ...
    %122 = llvm.insertelement %112, %1[%11 : i32] : vector<1xf32>
    %123 = llvm.bitcast %122 : vector<1xf32> to i32
    %124 = llvm.insertelement %113, %1[%11 : i32] : vector<1xf32>
    %125 = llvm.bitcast %124 : vector<1xf32> to i32
    %126 = llvm.insertelement %114, %1[%11 : i32] : vector<1xf32>
    %127 = llvm.bitcast %126 : vector<1xf32> to i32
    %128 = llvm.insertelement %115, %1[%11 : i32] : vector<1xf32>
    %129 = llvm.bitcast %128 : vector<1xf32> to i32
    %130 = nvvm.read.ptx.sreg.tid.x : i32
    %131 = llvm.urem %130, %12 : i32
    %132 = llvm.udiv %130, %12 : i32
    %133 = llvm.and %11, %131 : i32
    %134 = llvm.icmp "eq" %133, %11 : i32
    %135 = llvm.and %0, %134 : i1
    %136 = llvm.and %11, %132 : i32
    %137 = llvm.icmp "eq" %136, %11 : i32
    %138 = llvm.and %135, %137 : i1
    %139 = llvm.and %138, %54 : i1
    %140 = llvm.inline_asm has_side_effects asm_dialect = att operand_attrs = [] "@$5 st.global.v4.b32 [ $4 + 0 ], { $0, $1, $2, $3 };", "r,r,r,r,l,b" %123, %125, %127, %129, %120, %139 : (i32, i32, i32, i32, !llvm.ptr<1>, i1) -> !llvm.void
    %141 = llvm.insertelement %116, %1[%11 : i32] : vector<1xf32>
    %142 = llvm.bitcast %141 : vector<1xf32> to i32
    %143 = llvm.insertelement %117, %1[%11 : i32] : vector<1xf32>
    %144 = llvm.bitcast %143 : vector<1xf32> to i32
    %145 = llvm.insertelement %118, %1[%11 : i32] : vector<1xf32>
    %146 = llvm.bitcast %145 : vector<1xf32> to i32
    %147 = llvm.insertelement %119, %1[%11 : i32] : vector<1xf32>
    %148 = llvm.bitcast %147 : vector<1xf32> to i32
    %149 = nvvm.read.ptx.sreg.tid.x : i32
    %150 = llvm.urem %149, %12 : i32
    %151 = llvm.udiv %149, %12 : i32
    %152 = llvm.and %11, %150 : i32
    %153 = llvm.icmp "eq" %152, %11 : i32
    %154 = llvm.and %0, %153 : i1
    %155 = llvm.and %11, %151 : i32
    %156 = llvm.icmp "eq" %155, %11 : i32
    %157 = llvm.and %154, %156 : i1
    %158 = llvm.and %157, %55 : i1
    %159 = llvm.inline_asm has_side_effects asm_dialect = att operand_attrs = [] "@$5 st.global.v4.b32 [ $4 + 0 ], { $0, $1, $2, $3 };", "r,r,r,r,l,b" %142, %144, %146, %148, %121, %158 : (i32, i32, i32, i32, !llvm.ptr<1>, i1) -> !llvm.void
    llvm.return
  }
}
